...
namespace AdminMnsV1.Migrations
{
    ...
    [Migration("20250611124832_CreateTableDelayAbsenceStatusReason")]
    partial class CreateTableDelayAbsenceStatusReason
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminMnsV1.Models.Abscences.Absence", b =>
                {
                    ...
                    b.Property<int>("ReasonAbsenceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdminMnsV1.Models.Absences.ReasonAbsence", b =>
                {
                    b.Property<int>("ReasonAbsenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReasonAbsenceId"));

                    b.Property<string>("ReasonWording")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.HasKey("ReasonAbsenceId");

                    b.ToTable("ReasonAbsences");
                });
            ...
            modelBuilder.Entity("AdminMnsV1.Models.DelayAbsStatus", b =>
                {
                    b.Property<int>("DelayAbsStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DelayAbsStatusId"));
                    ...
                    b.HasKey("DelayAbsStatusId");

                    b.ToTable("DelayAbsStatuses");
                });

            modelBuilder.Entity("AdminMnsV1.Models.Delays.ReasonDelay", b =>
                {
                    b.Property<int>("ReasonDelayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReasonDelayId"));
                    ...
                    b.HasKey("ReasonDelayId");

                    b.ToTable("ReasonDelays");
                });
            ...
            modelBuilder.Entity("Delay", b =>
                {
                    b.Property<int>("DelayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DelayId"));
            ...
            modelBuilder.Entity("AdminMnsV1.Models.Abscences.Absence", b =>
                {
                    b.HasOne("AdminMnsV1.Models.Administrator", "Administrator")
                        .WithMany()
                        .HasForeignKey("AdministratorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AdminMnsV1.Models.Absences.ReasonAbsence", "ReasonAbsence")
                        .WithMany()
                        .HasForeignKey("ReasonAbsenceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AdminMnsV1.Models.DelayAbsStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("AdminMnsV1.Models.Attend", b =>
                {
                    b.HasOne("AdminMnsV1.Models.Administrator", null)
                        .WithMany("Attends")
                        .HasForeignKey("AdministratorId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Delay", b =>
                {
                    ...
                    b.HasOne("AdminMnsV1.Models.Delays.ReasonDelay", "ReasonDelay")
                        .WithMany()
                        .HasForeignKey("ReasonDelayId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
